...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        // Сортировка интервалов по времени окончания (в порядке возрастания).
        // Это помогает минимизировать использование интервалов и завершать задачи как можно раньше.
